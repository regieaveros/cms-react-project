      ...
      <div className={classes.root}>
        ...
        >
          ...
          <Switch>
            ...
            <Route path="/app/template2-services" component={temp2Services} />
            <Route path="/app/template2-work-showcase" component={temp2WorkShowcase} />
            <Route path="/app/template2-news" component={temp2News} />
            <Route path="/app/template2-best-services" component={temp2BestServices} />
            <Route path="/app/template2-testimonials" component={temp2Testimonials} />
            <Route path="/app/template2-professionals" component={temp2Professionals} />
            <Route path="/app/template2-social-media" component={temp2SocialMedia} />
          </Switch>
        </div>
      </div>
    </>
